...
module.exports = exports = nano = function dbScope(cfg) {
  ...
  serverScope = Object.assign(serverScope, {
    db: {
      create: function () { return promiseWrapper(createDb, arguments) },
      get: function () { return promiseWrapper(getDb, arguments) },
      destroy: function () { return promiseWrapper(destroyDb, arguments) },
      list: function () { return promiseWrapper(listDb, arguments) },
      use: docModule,
      scope: docModule,
      compact: function () { return promiseWrapper(compactDb, arguments) },
      replicate: function () { return promiseWrapper(replicateDb, arguments) },
      replication: {
        enable: function () { return promiseWrapper(enableReplication, arguments) },
        disable: function () { return promiseWrapper(disableReplication, arguments) },
        query: function () { return promiseWrapper(queryReplication, arguments) }
      },
      changes: function () { return promiseWrapper(changesDb, arguments) },
      follow: function () { return promiseWrapper(followDb, arguments) },
      followUpdates: function () { return promiseWrapper(followUpdates, arguments) },
      updates: function () { return promiseWrapper(updates, arguments) }
    },
    use: docModule,
    scope: docModule,
    request: function () { return promiseWrapper(relax, arguments) },
    relax: function () { return promiseWrapper(relax, arguments) },
    dinosaur: function () { return promiseWrapper(relax, arguments) },
    auth: function () { return promiseWrapper(auth, arguments) },
    session: function () { return promiseWrapper(session, arguments) },
    updates: function () { return promiseWrapper(updates, arguments) },
    followUpdates: function () { return promiseWrapper(followUpdates, arguments) },
    uuids: function () { return promiseWrapper(uuids, arguments) }
  });
